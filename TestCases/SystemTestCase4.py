...
driver7.get ('https://web-sandbox.openrainbow.com/app/1.69.3/index.html')
username = driver7.find_element_by_id ("username")
...
driver7.find_element_by_xpath (Continue).click()
time.sleep(2)
pwd = driver7.find_element_by_id ("authPwd")
...
driver7.find_element_by_xpath (Connect).click()
