...
driver9 = webdriver.Chrome(chrome_options=options)
...
driver10 = webdriver.Chrome(chrome_options=options)
...
driver11 = webdriver.Chrome(chrome_options=options)
...
driver7 = webdriver.Chrome(chrome_options=options)
...
driver8 = webdriver.Chrome(chrome_options=options)
...
driver12 = webdriver.Chrome(chrome_options=options)
...
driver15 = webdriver.Chrome(chrome_options=options)
...
driver18 = webdriver.Chrome(chrome_options=options)
...
driver19 = webdriver.Chrome(chrome_options=options)
...
driver20 = webdriver.Chrome(chrome_options=options)
driver20.set_window_position(1000, 0)
driver20.set_window_size(320, 400)
driver20.get('https://escproject.sutd.org/')
time.sleep(3)
driver20.find_element_by_xpath(Live_Chat).click()

driver21 = webdriver.Chrome(chrome_options=options)
driver21.set_window_position(1000, 370)
...
driver.set_window_position(1000, 740)
...
driver5 = webdriver.Chrome(chrome_options=options)
driver5.set_window_position(1250, 0)
...
driver14 = webdriver.Chrome(chrome_options=options)
driver14.set_window_position(1250, 370)
...
driver17 = webdriver.Chrome(chrome_options=options)
driver17.set_window_position(1250, 740)
...
driver.set_window_position(500, 50)
wait = WebDriverWait(driver, 100)
time.sleep(2)
...
driver5.set_window_position(500, 700)
wait = WebDriverWait(driver5, 100)
time.sleep(2)
Connect = "/html/body/div[2]/authentication-component/authentication-window-component/div/div[1]/div[2]/div[2]/authentication-window-content/div/authentication-form-component/form/square-button/div/div/span[2]"
time.sleep(1)
...
driver14.set_window_position(1100, 150)
wait = WebDriverWait(driver14, 100)
time.sleep(2)
Connect = "/html/body/div[2]/authentication-component/authentication-window-component/div/div[1]/div[2]/div[2]/authentication-window-content/div/authentication-form-component/form/square-button/div/div/span[2]"
time.sleep(1)
...
driver17.set_window_position(1100, 700)
wait = WebDriverWait(driver17, 100)
time.sleep(2)
Connect = "/html/body/div[2]/authentication-component/authentication-window-component/div/div[1]/div[2]/div[2]/authentication-window-content/div/authentication-form-component/form/square-button/div/div/span[2]"
time.sleep(1)
